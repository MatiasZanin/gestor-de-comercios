...
| **POST /{commerceId}/billing/subscribe**          | Iniciar suscripción, con trial sólo si fue concedido y no consumido; requiere propietario e `Idempotency-Key`. |
